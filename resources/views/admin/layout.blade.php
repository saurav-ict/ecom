...
<aside id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-item">
            <a href="{{ route('admin.properties.index') }}" class="{{ request()->is('admin/properties*') ? 'active' : '' }}">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <form method="POST" action="{{ route('admin.logout') }}" class="ms-1">
                @csrf
...
<header id="topbar">
    ...
    <div class="topbar-actions">
        ...
        <div class="dropdown ms-1">
            <button class="topbar-avatar dropdown-toggle" data-bs-toggle="dropdown" style="border:none;">{{ strtoupper(substr(auth()->user()->name, 0, 1)) }}</button>
